...
namespace Ingredients\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Ingredients\Faker\IngredientProvider;
...
class IngredientsServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'Ingredients');
        $this->registerFakerProviders();
        $this->publishes([
            __DIR__ . '/../Resources/lang' =>   resource_path('lang/vendor/Ingredients'),
        ], 'ingredients');
